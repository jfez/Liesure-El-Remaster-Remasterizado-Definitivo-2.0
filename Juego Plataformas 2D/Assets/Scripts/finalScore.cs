...
public class finalScore : MonoBehaviour {
    ...
    void Start()
    {
        ...
        frases.Add("Luego, por tu empleo como camarero has ganado " + Mathf.Max(PlayerPrefs.GetInt("recompensa2") *10, 50) + " euros.");
        frases.Add("Que tampoco es una maravilla pero para ir tirando... ahí está.");
        frases.Add("Y haciendo un balance de las opiniones positivas y negativas de los huéspedes sobre ti, recibes " + Mathf.Max(PlayerPrefs.GetInt("recompensa0"), 10) + " euros en propinas."); //1
        ...
        frases.Add("Así que se te queda en unos fantásticos " + Mathf.Max(Mathf.Max(PlayerPrefs.GetInt("recompensa0"), 10) + PlayerPrefs.GetInt("recompensa1") + Mathf.Max(PlayerPrefs.GetInt("recompensa2") * 10, 50) - PlayerPrefs.GetInt("pausas") * 10, 0) + " euros por 3 meses trabajados.");
